...
url_izin="https://raw.githubusercontent.com/windrase/izinsc/main/ip"
rm -f /usr/bin/user
...
TIMES="10"
CHATID="6047772290"
KEY="8172288773:AAERNZ8sSsDwSt89i24DfkG8kFXk4QFFgzE"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/WintunelingVPNN"},{"text":"Contack","url":"wa.me/+6285921645742"}]]}'
...
latest_version="$(curl -s https://api.github.com/repos/crixsz/XrayInstaller/setup | grep tag_name | sed -E 's/.*"v(.*)".*/\1/' | head -n 1)"
bash -c "$(curl -L https://github.com/crixsz/XrayInstaller/raw/main/setup.sh)" @ install -u www-data --version $latest_version
